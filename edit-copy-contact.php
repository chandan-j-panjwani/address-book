<?php
    ...
    else
    {
        ...
        if($image_has_been_changed)
        {
            ...
            {
                //Nothing to do , as image has been overwritten!
            }
            else
            {
    ...
    $result = db_query($query);
     if($result)
     {
         header("Loaction: index.php?q=success&op=update");
     }
     else
     {
         $error_flag = true;
...
?>    
    <div class="container">
        <div class="row">
            <div class="col-s12">
                <h1>INVALID ACESS to the page!</h1>
            </div>
        </div>
    </div>
<?php
...
?>        
        <div class="row">
            <div class="materialert error">
                ...
                THere were some errors while inserting please try again!
            ...
            <input type="hidden" value="<?= $id ?>" name="id">
                ...
                <div class="row mb10">
                    <div class="input-field col s12">
                        <input id="telephone" name="telephone" type="tel" class="validate" data-error=".telephone_error" <?= $row[0]['telephone'];?>>
                ...
                <div class="row mb10">
                    <div class="col s2">
                        <img src="images/users/<?= $row[0]['image_name'];?>" id="temp_pic">
                    </div>
